...
def convert_comprehensive_md_to_latex():
    ...
    with open('/Users/a.rocchi/Projects/Personal/AlphaPulse/paper.md', 'r', encoding='utf-8') as f:
        md_content = f.read()
...
def main():
    ...
    try:
        ...
        with open('/Users/a.rocchi/Projects/Personal/AlphaPulse/paper_comprehensive.tex', 'w', encoding='utf-8') as f:
            f.write(latex_content)
        
        print(f"Created comprehensive LaTeX file: {len(latex_content)} characters")
        print("File: paper_comprehensive.tex")
