...
class TestAPIStartupServices:
    ...
    async def test_database_optimization_service_initialization(self):
        ...
        with patch('alpha_pulse.api.main.DatabaseOptimizationService') as MockDBService, \
             patch('alpha_pulse.api.main.get_database_config') as mock_get_config:
    ...
    async def test_services_graceful_failure(self):
        ...
        with patch('alpha_pulse.api.main.CachingService') as MockCachingService, \
             patch('alpha_pulse.api.main.logger') as mock_logger:
            
            # Make initialization fail
            MockCachingService.create_for_trading.side_effect = Exception("Redis connection failed")
            ...
            async def simulate_startup():
                ...
                mock_logger.error.assert_any_call("Error initializing CachingService: Redis connection failed")
    ...
    async def test_all_services_initialization_order(self):
        ...
        with patch('alpha_pulse.api.main.CachingService') as MockCaching, \
             patch('alpha_pulse.api.main.DatabaseOptimizationService') as MockDB, \
             patch('alpha_pulse.api.main.DataAggregationService') as MockData, \
             patch('alpha_pulse.api.main.get_database_config'):
...
class TestPerformanceEndpoints:
    ...
    def test_cache_metrics_endpoint_active(self):
        ...
        with patch('alpha_pulse.api.main.app') as mock_app:
            ...
            mock_app.state.caching_service.get_metrics = AsyncMock(return_value={
                'hit_rate': 0.90,
                'total_requests': 5000,
                'cache_hits': 4500,
                'cache_misses': 500,
    ...
    def test_database_metrics_endpoint_active(self):
        ...
        test_app.state.db_optimization_service.get_performance_metrics = AsyncMock(return_value={
