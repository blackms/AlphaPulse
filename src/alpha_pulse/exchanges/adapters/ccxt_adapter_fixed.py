                ...
                try:
                    ...
                    history_params = {
                        **direct_params,
                        ...
                        # orderStatus parameter is causing the error - removing it
                        # According to Bybit API docs, we should not specify orderStatus here
                    }
                    ...
                    # Check if direct_orders exists or is empty
                    if 'direct_orders' not in locals() or not direct_orders:
                        try:
                            # Use orderStatus parameter instead of openOnly for the V5 API
                            realtime_params = {
                                **direct_params,
                                'category': 'spot',
                                'orderStatus': 'all'  # 'all' means all orders (both active and historic)
                            }
