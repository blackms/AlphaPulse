...
def fix_math_expressions():
    ...
    with open('/Users/a.rocchi/Projects/Personal/AlphaPulse/paper_comprehensive.tex', 'r', encoding='utf-8') as f:
        content = f.read()
...
def main():
    ...
    try:
        ...
        with open('/Users/a.rocchi/Projects/Personal/AlphaPulse/paper_comprehensive_fixed.tex', 'w', encoding='utf-8') as f:
